...
public enum ResultCode {
    ...
    USER_RIGHT_LACKING(20019, "权限不足"),
    USER_LOGIN_FIRST(20020, "请先登陆"),
    ...
    USER_HAS_SECURITY(20201, "密保已设定"),
    USER_ADD_SECURITY_ERROR(20202, "添加账号密保错误"),
    USER_NOT_SECURITY(20203, "未添加密保"),
    USER_FIND_SECURITY_ERROR(20204, "查找密保错误"),
    USER_UPDATE_SECURITY_ERROR(20205, "更改密保错误"),
    USER_DELETE_SECURITY_ERROR(20206, "删除密保错误"),
