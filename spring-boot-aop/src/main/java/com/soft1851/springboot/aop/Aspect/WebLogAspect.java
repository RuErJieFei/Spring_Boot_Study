...
public class WebLogAspect {
    ...
    public void doBefore(JoinPoint joinPoint, ControllerWebLog controllerWebLog) {
        ...
        log.info("连接点对象通过反射获取的类名和方法名" + joinPoint.getSignature().getDeclaringTypeName() + "."
     ...
     * 可通过连接点入参数和反射机制，在这里调用目标方法getHello(),并返回调用结果
     *
